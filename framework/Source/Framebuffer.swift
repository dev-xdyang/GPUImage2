...
public class Framebuffer {
    ...
    public init(context: OpenGLContext, orientation: ImageOrientation, size: GLSize, textureOnly: Bool = false,
                minFilter: Int32 = GL_LINEAR, magFilter: Int32 = GL_LINEAR,
                wrapS: Int32 = GL_CLAMP_TO_EDGE, wrapT: Int32 = GL_CLAMP_TO_EDGE,
                internalFormat: Int32 = GL_RGBA, format: Int32 = GL_BGRA,
                type: Int32 = GL_UNSIGNED_BYTE, stencil: Bool = false,
                overriddenTexture: GLuint? = nil) throws {
        ...
        hash = hashForFramebufferWithProperties(orientation: orientation, size: size, textureOnly: textureOnly,
                                                minFilter: minFilter, magFilter: magFilter,
                                                wrapS: wrapS, wrapT: wrapT,
                                                internalFormat: internalFormat, format: format,
                                                type: type, stencil: stencil)
    ...
    public func activateFramebufferForRendering() {
        guard let framebuffer = framebuffer else {
            fatalError("ERROR: Attempted to activate a framebuffer that has not been initialized")
        }
...
func hashForFramebufferWithProperties(orientation _: ImageOrientation, size: GLSize, textureOnly: Bool = false,
                                      minFilter _: Int32 = GL_LINEAR, magFilter _: Int32 = GL_LINEAR,
                                      wrapS _: Int32 = GL_CLAMP_TO_EDGE, wrapT _: Int32 = GL_CLAMP_TO_EDGE,
                                      internalFormat: Int32 = GL_RGBA, format: Int32 = GL_BGRA,
                                      type: Int32 = GL_UNSIGNED_BYTE, stencil: Bool = false) -> Int64 {
    var result: Int64 = 1
    let prime: Int64 = 31
